...
var st;null===(st=window.HTMLSlotElement)||void 0===st||st.prototype.assignedElements;var rt,at;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(rt||(rt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(at||(at={}));var lt=function(t,e,i,o){o=o||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});return n.detail=i,t.dispatchEvent(n),n};let ct=class extends Y{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get _show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get _tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"none"}}get _hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get _double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){if(!this.hass||!this._helpers)return z``;this._helpers.importMoreInfoControl("climate");const t=Object.keys(this.hass.states).filter(t=>"climate"===t.substr(0,t.indexOf(".")));return z`
    ...
    `}};t([ot({attribute:!1})],ct.prototype,"hass",void 0),t([nt()],ct.prototype,"_config",void 0),t([nt()],ct.prototype,"_toggle",void 0),t([nt()],ct.prototype,"_helpers",void 0),ct=t([et("obvious-thermostat-editor")],ct);const dt={off:"mdi:power",auto:"mdi:calendar-sync",heat_cool:"mdi:autorenew",heat:"mdi:fire",cool:"mdi:snowflake",fan_only:"mdi:fan",dry:"mdi:water-percent"},ht={off:"off",auto:"auto",heat_cool:"heat/​cool",heat:"heat",cool:"cool",fan_only:"fan only",dry:"dry"};var ut={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},pt={common:ut},vt={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},mt={common:vt};const ft={en:Object.freeze({__proto__:null,common:ut,default:pt}),nb:Object.freeze({__proto__:null,common:vt,default:mt})};function gt(t,e="",i=""){const o=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let n;try{n=t.split(".").reduce((t,e)=>t[e],ft[o])}catch(e){n=t.split(".").reduce((t,e)=>t[e],ft.en)}return void 0===n&&(n=t.split(".").reduce((t,e)=>t[e],ft.en)),""!==e&&""!==i&&(n=n.replace(e,i)),n}let _t=class extends Y{constructor(){super(...arguments),this.step=1,this._debouncedSet=function(t,e,i){var o;return void 0===i&&(i=!1),function(){var n=[].slice.call(arguments),s=this,r=function(){o=null,i||t.apply(s,n)},a=i&&!o;clearTimeout(o),o=setTimeout(r,e),a&&t.apply(s,n)}}(t=>{const e=new CustomEvent("change",{detail:{newValue:t},bubbles:!0,composed:!0});this.dispatchEvent(e)},2e3)}render(){return z`
      <div class="wrapper">
    ...
    `}};t([ot({type:Number})],_t.prototype,"value",void 0),t([ot({type:String})],_t.prototype,"units",void 0),t([ot({type:Number})],_t.prototype,"min",void 0),t([ot({type:Number})],_t.prototype,"max",void 0),t([ot({type:Number})],_t.prototype,"step",void 0),_t=t([et("custom-climate-control")],_t);let yt=class extends Y{render(){return z`
      <div class="wrapper">
    ...
    `}};t([ot({type:Number})],yt.prototype,"value",void 0),t([ot({type:String})],yt.prototype,"units",void 0),yt=t([et("current-temperature")],yt),console.info(`%c  obvious-thermostat \n%c  ${gt("common.version")} 1.0.0    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"obvious-thermostat",name:"Custom Thermostat",description:"A template custom card for you to create something awesome"});let $t=class extends Y{static async getConfigElement(){return document.createElement("obvious-thermostat-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error(gt("common.invalid_configuration"));if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("Specify an entity from within the climate domain.");this.config=Object.assign({name:"Thermostat"},t)}shouldUpdate(t){return!!this.config&&function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var o=e.get("hass");return!o||o.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){var t;if(!this.hass||!this.config)return z``;const e=this.hass.states[this.config.entity],i=null===(t=this.config)||void 0===t?void 0:t.name,o=null!==e.attributes.temperature&&Number.isFinite(Number(e.attributes.temperature))?e.attributes.temperature:e.attributes.min_temp,n=z`
        <custom-climate-control
          ...
          ></custom-climate-control>`,s=z`
        <current-temperature
          .value=${e.attributes.current_temperature}
          .units=${this.hass.config.unit_system.temperature}></current-temperature>`;return z`
      <ha-card
      ...
      <div class="modes">
      ${e.attributes.hvac_modes.map(t=>{let i;return t===e.state&&(i="active"),z`
        <div
          id=${t}
          class="mode-item ${i} ${t}"
          @click=${this._setMode}>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t,e){return(({finisher:t,descriptor:e})=>(i,o)=>{var n;if(void 0===o){const o=null!==(n=i.originalKey)&&void 0!==n?n:i.key,s=null!=e?{kind:"method",placement:"prototype",key:o,descriptor:e(i.key)}:{...i,key:o};return null!=t&&(s.finisher=function(e){t(e,o)}),s}{const n=i.constructor;void 0!==e&&Object.defineProperty(i,o,e(o)),null==t||t(n,o)}})({descriptor:i=>{const o={get(){var e,i;return null!==(i=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==i?i:null},enumerable:!0,configurable:!0};if(e){const e="symbol"==typeof i?Symbol():"__"+i;o.get=function(){var i,o;return void 0===this[e]&&(this[e]=null!==(o=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(t))&&void 0!==o?o:null),this[e]}}return o}})}("ha-card")],$t.prototype,"_card",void 0),$t=t([et("obvious-thermostat")],$t);export{$t as BoilerplateCard};
